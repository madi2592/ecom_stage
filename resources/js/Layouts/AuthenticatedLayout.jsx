            ...
            >
                ...
                <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    {isSidebarOpen && (
                        ...
                        <p className="px-4 pt-4 pb-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">Gestion Stock</p>
                    ...
                    <div className="space-y-1">
                        ...
                        <button
                            ...
                            onClick={() => isSidebarOpen ? setIsCatalogueOpen(!isCatalogueOpen) : setIsSidebarOpen(true)}
            ...
            <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarOpen ? 'pl-72' : 'pl-20'}`}>
                ...
                <header className="bg-white sticky top-0 z-40 border-b border-gray-200 shadow-sm px-8 h-20 flex items-center">
                    ...
                    <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
                        ...
                        {/* Titre de la page (Header dynamique) */}
...
function SidebarLink({ href, icon, label, active, isOpen }) {
    ...
    return (
        ...
        <Link href={href} className={`flex items-center p-3 rounded-xl transition-all group ${active ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}>
...
function SidebarSubLink({ href, label, active, icon }) {
    ...
    return (
        ...
        <Link href={href} className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors text-sm ${active ? 'text-indigo-400 font-bold' : 'text-slate-500 hover:text-slate-200'}`}>
