        ...
        <div className="fixed inset-0 bg-black/40 z-[80] flex items-center justify-center px-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8">
                <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                        onClick={onClose}
                        className="text-gray-300 hover:text-black ml-4"
                    >
                        <X size={18} />
                    </button>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="mb-10">
                        <Link
                            ...
                            className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 hover:text-[#0315ff] transition-colors"
                        >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                            ...
                            <div className="lg:col-span-8 space-y-4">
                                ...
                                <div className="space-y-4">
                                    {items.map((item) => (
                                        <div
                                            key={item.cart_key}
                                            className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col md:grid md:grid-cols-12 items-center gap-6"
                                        >
                                            {/* Détails Produit */}
                                            <div className="col-span-6 flex items-center gap-6 w-full">
                                                ...
                                                <div className="flex flex-col">
                                                    <h3 className="font-black text-black uppercase text-sm leading-tight mb-1">
                                                        {item.libelle}
                                                    </h3>
                            ...
                            <div className="lg:col-span-4">
                                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl sticky top-28">
                                    ...
                                    <Link
                                        href={route("checkout")}
                                        className="block w-full bg-[#0315ff] text-white py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-xs hover:bg-black transition-all transform hover:-translate-y-1 shadow-lg shadow-blue-500/20 hover:shadow-black/20 text-center"
                                    >
                                        Passer à la caisse
                                    </Link>
                        ...
                        <div className="bg-white rounded-3xl p-16 sm:p-32 text-center border border-gray-100 shadow-sm">
                            <div className="max-w-xs mx-auto">
                                ...
                                <p className="text-gray-400 text-sm mb-10 leading-relaxed">
                                    Il semble que vous n'ayez pas encore ajouté
                                    de coups de cœur à votre panier.
                                </p>
                                <Link
                                    href={route("shop.catalogue")}
